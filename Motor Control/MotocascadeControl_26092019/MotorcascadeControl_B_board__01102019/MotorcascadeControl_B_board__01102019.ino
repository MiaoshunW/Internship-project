...
double kp =0.1, ki=0.001, kd =0.00010; // modify for optimal performance
...
double kp2 =2, ki2=0.001, kd2 =0.00010; // modify for optimal performance
double input3 = 0, output3 = 0, Velocity2 = 0;
double kp3 =0.1, ki3=30, kd3 =0.000; // modify for optimal performance
...
radio.openReadingPipe(1,slaveAddress[1]); //receiver address
...
void loop() { 
   currentMillis = millis();
    ...
    getData();
    //=====================Motor1======================================
    Position= smotor1; //*sig;//30degree
    input = encoderPos ;
    myPID.Compute(); 
    
    Position2= smotor2; //*sig;//30degree
    input2= encoderPos2 ;
    myPID2.Compute();   
    prevMillis = millis();
    } 
     ...
     buf1=encoderPos;
     dbuf=buf1-buf2;
    Speed=output*0.5;//here change the Speed now is 0.5of full speed 
    speedup();
    speeddown();      
    input0=dbuf; 
    myPID0.Compute(); 
    ...
    buf3=encoderPos2;
    dbuf2=buf3-buf4;
    Speed2=output2*0.5;//here change the Speed now is 0.5of full speed 
    speedup2();
    speeddown2();      
    input3=dbuf2; 
    myPID3.Compute(); 
