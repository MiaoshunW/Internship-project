...
double kp =0.05, ki=0.001, kd =0.00010; // modify for optimal performance
double input0 = 0, output0 = 0, Velocity = 0;
double kp0 =0.01, ki0=30, kd0 =0.000; // modify for optimal performance

double input2 = 0, output2 = 0, Position2 = 0;
double kp2 =0.05, ki2=0.001, kd2 =0.00010; // modify for optimal performance
...
radio.openReadingPipe(1,slaveAddress[3]); //receiver address
   ...
   currentMillis = millis();
    ...
    //=============================Print out========================
         dataSend[0]=encoderPos;     //real position of motor 1
          ...
          dataSend[2]=dbuf;           //real speed of motor 1
          dataSend[3]=dbuf2;          //real speed of motor 2
     senddata();
